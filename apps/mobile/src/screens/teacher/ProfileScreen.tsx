/**
 * Vaasenk Mobile — Teacher ProfileScreen (Sprint 7.3).
 *
 * Same structural layout as the student ProfileScreen but in Teacher
 * Orange (goldCard gradient) and with teacher-specific copy. Settings
 * rows are stubbed pending Sprint 7.4 (push notifications) and Sprint 8
    ...
    >
      ...
      >
        ...
        {user?.institution?.name ? (
          ...
          >
            <GraduationCap size={14} color={vaasenkNative.colors.text.inverse} />
            <Text
              style={{
                color: vaasenkNative.colors.text.inverse,
                fontWeight: '700',
        ...
        >
          <Sparkles size={12} color={vaasenkNative.colors.brand.gold} />
          <Text
            style={{
      ...
      >
        <SettingRow
          ...
          label="Notifications"
          hint="Push notifications arrive in Sprint 7.4"
          disabled
        />
        <Divider />
        <SettingRow
          icon={<Sparkles size={18} color={vaasenkNative.colors.brand.red} />}
          label="AI credits"
          hint="Tracked in the web dashboard"
          disabled
        />
        <Divider />
        <SettingRow
